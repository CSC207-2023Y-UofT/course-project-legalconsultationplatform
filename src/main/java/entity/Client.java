...
// Setter methods
    ...
    /**
     * Set the ethnicity of the client.
     *
     * @param ethnicity The new ethnicity of the client.
     */
     ...
     *
     * @param gender The new gender of the client.
     */
    ...
    /**
     * Set the marital status of the client.
     *
     * @param maritalStatus The new marital status of the client.
     */
    ...
    /**
     * Set the number of household members of the client.
     *
     * @param numberOfHousehold The new number of household members of the client.
     */
    ...
    /**
     * Set the annual income of the client.
     *
     * @param annualIncome The new annual income of the client.
     */
     ...
     *
     * @return True indicating the user is a client.
     */
    @Transient
    @Override
